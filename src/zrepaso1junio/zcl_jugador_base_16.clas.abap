...
CLASS zcl_jugador_base_16 DEFINITION
  PUBLIC
  ABSTRACT
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES zif_puntuable_16.
    INTERFACES zif_clasificable_16.
...
CLASS zcl_jugador_base_16 IMPLEMENTATION.
  ...
  METHOD zif_clasificable_16~esta_clasificado.
    IF mv_victorias >= 3.
      rv_result = abap_true.
    ELSE.
  ...
  METHOD zif_clasificable_16~get_posicion_ranking.
